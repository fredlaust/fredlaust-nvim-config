-- https://www.dmsussman.org/resources/neovimsetup/ ---- hentet derfra
return {
    {
        'lervag/vimtex',
        ft = 'tex',
        ...
        config = function()
            ...
            vim.g.vimtex_view_method = 'sioyek' -- change this, depending on what you want to use..sumatraPDF, or skim, or zathura, or...
